package com.example.isdl.multigestureuntildecember;
...
//    private String subjectName;
    ...
    //version: 0.0 (init) >> 1.0 (made icon) -> 2.0 (made some Button and TextView ) -> 3.0 (Synchronizing) -> 4.0 (Send illuminance data)
